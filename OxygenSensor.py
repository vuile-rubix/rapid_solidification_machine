...
import time
import math
sys.path.append("/home/wsu-rsm/Microcontrollertesting/OxygenSensorSetup/DFRobot_OxygenSensor-master/python/raspberrypi")
print(sys.path)
from DFRobot_Oxygen import *

COLLECT_NUMBER   = 10              # collect number, the collection range is 1-100
IIC_MODE         = 0x01            # default use IIC1 (byte location)
